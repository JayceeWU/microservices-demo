...
const (
	PaymentService_CreatePayment_FullMethodName     = "/dancehub.payments.v1.PaymentService/CreatePayment"
	PaymentService_GetPayment_FullMethodName        = "/dancehub.payments.v1.PaymentService/GetPayment"
	PaymentService_GetPaymentByOrder_FullMethodName = "/dancehub.payments.v1.PaymentService/GetPaymentByOrder"
	PaymentService_SimulatePayment_FullMethodName   = "/dancehub.payments.v1.PaymentService/SimulatePayment"
	PaymentService_RefundPayment_FullMethodName     = "/dancehub.payments.v1.PaymentService/RefundPayment"
)
...
type PaymentServiceClient interface {
	...
	SimulatePayment(ctx context.Context, in *SimulatePaymentRequest, opts ...grpc.CallOption) (*Payment, error)
...
func (c *paymentServiceClient) SimulatePayment(ctx context.Context, in *SimulatePaymentRequest, opts ...grpc.CallOption) (*Payment, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Payment)
...
type PaymentServiceServer interface {
	...
	SimulatePayment(context.Context, *SimulatePaymentRequest) (*Payment, error)
...
func (UnimplementedPaymentServiceServer) SimulatePayment(context.Context, *SimulatePaymentRequest) (*Payment, error) {
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dancehub.payments.v1.PaymentService",
