...
const (
	CartService_AddItem_FullMethodName    = "/dancehub.cart.v1.CartService/AddItem"
	CartService_GetCart_FullMethodName    = "/dancehub.cart.v1.CartService/GetCart"
	CartService_RemoveItem_FullMethodName = "/dancehub.cart.v1.CartService/RemoveItem"
	CartService_EmptyCart_FullMethodName  = "/dancehub.cart.v1.CartService/EmptyCart"
)
...
type CartServiceClient interface {
	...
	EmptyCart(ctx context.Context, in *EmptyCartRequest, opts ...grpc.CallOption) (*Cart, error)
}
...
func (c *cartServiceClient) EmptyCart(ctx context.Context, in *EmptyCartRequest, opts ...grpc.CallOption) (*Cart, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Cart)
...
type CartServiceServer interface {
	...
	EmptyCart(context.Context, *EmptyCartRequest) (*Cart, error)
...
func (UnimplementedCartServiceServer) EmptyCart(context.Context, *EmptyCartRequest) (*Cart, error) {
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dancehub.cart.v1.CartService",
