...
public sealed class MeshPeerPolicyTests
{
    private const string GatewayXfcc =
        "By=spiffe://cluster.local/ns/dancehub/sa/cartservice;Hash=7d3f;Subject=\"\";URI=spiffe://cluster.local/ns/dancehub/sa/gatewayservice";
    ...
    public void Peer_identity_comes_from_the_last_certificate_element()
    {
        const string forged = "URI=spiffe://cluster.local/ns/dancehub/sa/gatewayservice," +
            "By=spiffe://cluster.local/ns/dancehub/sa/cartservice;Hash=1a2b;URI=spiffe://cluster.local/ns/dancehub/sa/orderservice";
